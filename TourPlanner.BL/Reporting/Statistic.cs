...
namespace TourPlanner.BL.Reporting
{
    public class Statistic
    {
        ...
        private static string CreateHtml(IReadOnlyCollection<LogData> logList, IEnumerable<BikeData> bikeList,
            IEnumerable<CarData> carList, int tourId)
        {
        ...
        private static string General(IEnumerable<LogData> logList, int tourId)
        {
            ...
            stringBuilder.Append("<div class='triangleRight'></div>");
            stringBuilder.AppendFormat("<div class='text'> <p style='text-align:center'> {0} KM </p> </div>",
                distanceTraveled);
            ...
            IEnumerable<BikeData> bikeList, int tourId)
        {
            ...
            stringBuilder.Append("<div class='triangleRight'></div>");
            stringBuilder.AppendFormat("<div class='text'> <p style='text-align:center'> {0} BPM </p> </div>",
                peakHeartRate);
        ...
        private static string Car(IEnumerable<LogData> logList, IEnumerable<CarData> carList, int tourId)
        {
            ...
            stringBuilder.Append(
                "<div class='square'> <p style='text-align:center'> Times caught speeding:  </p> </div>");
            stringBuilder.Append("<div class='triangleRight'></div>");
            stringBuilder.AppendFormat("<div class='text'> <p style='text-align:center'> {0} KM </p> </div>",
                timesCaughtSpeeding);
