...
namespace TourPlanner.ViewModels
{
    public class DockPanelViewModel : INotifyPropertyChanged
    {
        ...
        {
            MessageBox.Show("Insert: Click on the Plus sign. Then, chose a tour name with source and destination which you need to validate. If the bar is red, the tour validation was not successful. . The distance of the tour is calculated automatically. Chose a description then click add." +
                            ...
                            "\n\nRefresh: If you think that your tour isn't in the list, click refresh. If you still cant find it the log doesn't exist.", "Tours", MessageBoxButton.OK, MessageBoxImage.Information);
        }

        private static void HelpLog()
        {
            MessageBox.Show("Insert: Click on the Plus sign. Then fill in all the fields with your data. Keep in mind, the time you should write the total time as such => TOTAL HOURS : TOTAL MINUTES (<= 59). You will need to choose to which tour this log should be added to. For this, check the tour list where you can also see the tour number. " +
                           ...
                           "\n\nRefresh: If you think that your log isn't in the list, click refresh. If you still cant find it, the log doesn't exist.", "Logs", MessageBoxButton.OK, MessageBoxImage.Information);
        }

        private static void HelpImportExport()
        {
            MessageBox.Show("Export: If you click export, all the tours that are currently in the list, will be imported as a json data. Select a destination and save it." +
                            "\n\nImport: The exported json data can be imported by selecting the exported file.", "Import and Export", MessageBoxButton.OK, MessageBoxImage.Information);
        }

        private static void HelpReportAndStatistic()
        {
            MessageBox.Show("Report: To create a report, select a tour of which you want to create a report of and click save which is on the bottom left." +
                            "\n\nStatistic: After saving a report of a tour you will be asked if you also want to save a statistic of the logs in that tour.", "Report and Statistic", MessageBoxButton.OK, MessageBoxImage.Information);
        }
